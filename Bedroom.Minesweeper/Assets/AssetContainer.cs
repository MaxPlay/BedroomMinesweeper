...
namespace Bedroom.Minesweeper.Assets
{
    ...
    {
        static int idGenerator; // I guess 4294967295 ids should be enough for all the assets in this game

        /// <summary>
        /// The storage for all the assets by id.
        /// </summary>
        Dictionary<int, T> assets;
        /// <summary>
        /// The storage for all the ids by name.
        /// </summary>
        Dictionary<string, int> assetLookup;
        /// <summary>
        ...
        private int ValidateLoadingRequest(string name, string file)
        {
            ...
            // We use unchecked, because we actually want the integer overflow.
            // In case we reach int.MaxValue, we want to get the next id in the safe range (this would be int.MinValue).
        ...
        /// <summary>
        /// Allows loading an asset from file (not as an xnb). This can be done with custom files or anything per runtime.
        /// </summary>
        /// <param name="name">The name of the asset in the application.</param>
        /// <param name="file">The filename of the asset.</param>
